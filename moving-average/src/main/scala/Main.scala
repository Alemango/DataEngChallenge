...
object MovingAverageApp extends LoggingTrait{
  def main(args: Array[String]): Unit = {
    ...
    Try {
      ...
      case Success(_) =>
        log("INFO", "MovingAverageApp finalizó con éxito")
        log("INFO", s"Código de salida: $OK")
      case Failure(ex) =>
        log("ERROR", s"MovingAverageApp falló: $ex")
        log("ERROR", s"Código de Salida: $ERROR")
    }
  }
}
